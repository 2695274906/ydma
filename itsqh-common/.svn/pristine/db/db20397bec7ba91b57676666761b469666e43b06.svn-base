...
public class YdmaConstant implements Serializable {
	...
	public static final String INSERT_LOGINHISTORY_SUCCESS_MSG = "登录记录添加成功";
	public static final String INSERT_LOGINHISTORY_ERROR_MSG = "登录记录添加失败";
	...
	public static final String UPDATE_NOTELIKECOUNT_ERROR2_MSG = "点赞失败";
	public static final String UPDATE_NOTELIKECOUNT_SUCCESS_MSG = "点赞成功";
