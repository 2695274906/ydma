...
public class NoteController {
	...
	@GetMapping("/user/findByUserIdAndVoideId2")
	public YdmaResult findByUserId2(
			@RequestParam("userId")int userId,
			@RequestParam("voidId")int voidId) {
		return noteService.selectByUserIdAndVideoId2(userId,voidId);
	}
	
	@GetMapping("/user/likeCount")
	public YdmaResult likeCount(@RequestParam("id")int id) {
		return noteService.addLikeCountById(id);
	}
	
	@GetMapping("/user/findNotes")
	public YdmaResult findNotesById(@RequestParam("noteId")int noteId) {
