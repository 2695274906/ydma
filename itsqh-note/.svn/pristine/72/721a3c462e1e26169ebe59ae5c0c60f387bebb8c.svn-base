...
public interface NoteMapper {
    ...
    @Select({
        ...
        "from note",
        "where id = #{notId,jdbcType=INTEGER}"
    })
    @Results({
    ...
    Note selectByPrimaryKey(@Param("notId")Integer notId);
    ...
    List<Note> selectByVideoId(Integer id);
    ...
    List<Note> selectByUserIdAndVideoId(@Param("user_id")Integer userId, @Param("video_id")Integer voidId);
